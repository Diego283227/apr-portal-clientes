                  ...
                  <div className="w-full max-w-xl mx-auto">
                    <div className="relative flex items-end gap-2">
                      <textarea
                        ...
                        className="flex-1 px-4 py-3 border-2 border-blue-500 dark:border-gray-600 rounded-2xl resize-none focus:outline-none focus:ring-0 focus:border-blue-600 dark:focus:border-gray-500 transition-all bg-white dark:bg-[#52525b] text-gray-900 dark:text-gray-100 shadow-lg text-base placeholder-gray-400 dark:placeholder-gray-500 overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-400 [&::-webkit-scrollbar-thumb]:rounded-full dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar-thumb]:hover:bg-gray-500 dark:[&::-webkit-scrollbar-thumb]:hover:bg-gray-500"
                        rows={1}
                        style={{
                          minHeight: '52px',
                          maxHeight: '200px',
